...
function setBotResponse(val) {
	setTimeout(function () {
		if (val.length < 1) {
			...
			var BotResponse = '<img class="botAvatar" src="./static/img/botAvatar_5.png"><p class="botMsg">' + msg + '</p><div class="clearfix"></div>';
			...
			for (i = 0; i < val.length; i++) {
				...
				if (val[i].hasOwnProperty("text")) {
					var BotResponse = '<img class="botAvatar" src="./static/img/botAvatar_5.png"><p class="botMsg">' + val[i].text + '</p><div class="clearfix"></div>';
					$(BotResponse).appendTo('.chats').hide().fadeIn(1000);
				}
